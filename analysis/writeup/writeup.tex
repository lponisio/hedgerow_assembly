...
In this analysis the assembling hedgerows are set as the intercept, to
...
We see the same pattern in the plant data.
...
## (Intercept)  3.7160065  0.0920970   3.5332661      3.8987 < 2.2e-16 ***
## occ.date     0.7040012  0.2676157   0.1729936      1.2350  0.009884 ** 
## r.degree    -0.0010938  0.0032020  -0.0074472      0.0053  0.733375    
## scale        0.2869339  0.0191323   0.2489713      0.3249 < 2.2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## Fixed effects:
##                    Estimate Std. Error       df t value Pr(>|t|)    
## (Intercept)         0.90778    0.01965 37.00000  46.198  < 2e-16 ***
## SiteStatuscontrol  -0.08206    0.02414 35.13000  -3.400  0.00169 ** 
## SiteStatusmaturing  0.03339    0.03065 33.20000   1.089  0.28385    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
This area is then regressed against time ("ypr" again).
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.03661 -0.73640 -0.02933  0.62103  2.40910 
## 
## Random effects:
##  Groups   Name        Variance  Std.Dev.
##  Site     (Intercept) 0.0019852 0.04456 
##  Year     (Intercept) 0.0001163 0.01078 
##  Residual             0.0048546 0.06967 
## Number of obs: 80, groups:  Site, 14; Year, 8
## 
## Fixed effects:
##              Estimate Std. Error        df t value Pr(>|t|)    
## (Intercept)  0.331489   0.016356 11.040000  20.267 4.36e-10 ***
## ypr          0.001166   0.004144 34.880000   0.281     0.78    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
