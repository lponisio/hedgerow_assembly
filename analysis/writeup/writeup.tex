...
## (Intercept)  3.7160065  0.0854433   3.5464685      3.8855  < 2e-16 ***
## occ.date     0.7040012  0.2454156   0.2170433      1.1910  0.00504 ** 
## r.degree    -0.0010938  0.0032266  -0.0074960      0.0053  0.73533    
## scale        0.2869339  0.0185467   0.2501333      0.3237  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -1.99009 -0.62116 -0.07289  0.56358  2.37929 
## 
## Random effects:
##  Groups   Name        Variance  Std.Dev.
##  Site     (Intercept) 2.395e-03 0.048943
##  Year     (Intercept) 5.091e-05 0.007135
##  Residual             4.842e-03 0.069583
## Number of obs: 80, groups:  Site, 14; Year, 8
## 
## Fixed effects:
##              Estimate Std. Error        df t value Pr(>|t|)    
## (Intercept)  0.333299   0.016943 10.950000  19.671 6.85e-10 ***
## ypr          0.000965   0.004133 32.430000   0.233    0.817    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
