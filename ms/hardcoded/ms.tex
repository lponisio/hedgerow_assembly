...
1) Stability x persistence x community assembly - maybe the easiest part to put a theory. [H4]

2) Link assembly to restoration and ecosystem services, biodiversity crisis (input the former first paragraph). [H4]
...
4) Paragraph that starts with "Understanding network assembly..." [H1 and H2]
