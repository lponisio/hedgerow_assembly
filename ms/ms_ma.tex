...
\item To date, only a handufullof field studies have examined how networks
  ...
  %I think it is better to saw few, because there are some others like Olesen et al. 2011 and refs in there (7-13).  
...
%% keep trait analysis? - I think we should mention it, but present it only in the supplementary, because the other results are more interesting, we already have lots fo results. And also, I remember Camille (Jason's student that publishes that traits paper in EcoLet with the horrible pics) had a really hard time with the analysis, so i doint think we should give too much emphasis on it. 
...
through time. Alternatively, if the network is accumulating specialist % I removed the lastly because I thought it was confusing, like a third point besides Mod and Nestedness. 
...
below the extinction curve is used as a measure of network robustness. %Maybe cite the R function we used here?
...
% I love this figure, but it is hard to see the different collors of plants and pollinators (in print)... 
\begin{figure}
  \centering
...
%Maybe use the same color to all peripheral species communities? Are they giving us any extra information?
\begin{figure}
  \centering
...
% I think we should thank SF and CSSS somehow... 
