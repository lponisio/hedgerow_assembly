...
\begin{figure}
  \centering
  \includegraphics[width=.7\textwidth]{../analysis/speciesLevel/figures/closenessPanel.pdf}
  \caption{The change species closenss as the networks assemble.
    Points are the mean of a species' closeness across sites at each year of assembly. The
