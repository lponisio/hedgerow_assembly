...
and connected species. %% interaction beta div, time beta div??
...
of that species. We included random effects for species, as well as
site. We focused on the pollinator species because the hedgerow
flowers are planted and thus are not directly assembling. Because
degree and persistence were strongly correlated, ($\rho = 0.84$,
$p$-value $<$ $2*10^{-16}$), each explanatory variable was included in
...
network assembly affect the robustness. First, following
...
%% Marilia add perturbation methods here
