...
\begin{abstract}  
  ...
  % species extinction is related to the structure of networks. Lauren
  % - i changed the phrasing because structure of network and network
  % structure were too close.
...
\citep{peel2014detecting}. In ecolo% gical communities, such shifts may
