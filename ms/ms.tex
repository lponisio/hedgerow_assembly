...
There were no consistent trends in when change points occurred within
assembling hedgerows or across all sites, except many sites had
...
most of the assembling hedgerows did not undergo a signficiant
reorganization of interactions immediatly the hedgerow was planted
(i.e., the transition from weedy field margin to hedgerow). This
result is consistent with other studies finding that the gains in
species richness of both the plant and pollinators takes several years
post-restoration (Kremen and M'Gonigle, in prep).

Surprisingly, the species that were most variable in their network
...
species will take advanatge of the most advantage resources, which my
...
that given the opportunity and ability to use different resources,
species will often their network positions.

%% node/species turnover 
...
central, generalist core. With preferential attachment, however, we
could also expect connectance and specialization to increase, and see
neither. The increase in nestedness is thus more likely a consequence
of the enhancement of species richness through time \flagged{DO WE
  HAVE CITATIONS FOR THIS?}. In addition, though the colonization and
persistence of floral specialists increases with assembly
\citep{mgonigle-2015-x}, this must be accumpanied changes in the diet
breat of the present species in order for network-level specialization
to remain constant through time.  

Preferential attachment is the most widely accepted theory explaining
network assembly, but few ecological studies have been conducted that
test for this mechanism \citep{Olesen2008}. \flagged{other
  citations??}. Though \cite{Olesen2008} found some evidence for an
assmbly process like prefrential attachment governming the temporal
...
mechanism is at play. Plant-pollinator networks in general are highly
dynamic, with high turnover of species and interactions both within
and between seasons \citep{Burkle2011}. Though our non-assembling
communities experience fewer network reorganizations than the
assembling hedgerows, $82\%$ of field marings and $40\%$ of mature
hedgerows underwent at least one changing point in network
structure. Few alternative models to perferential attachment that
predict these network reorganizations have been explored, however. 

Complementarity between traits like tounge length and corolla depth as
well as body and flower impose some biophysical limits to the
interactions between plants and pollintors
\citep{Vazquez2009evaluating, Stang2009, Stang2006,
  Santamaria2007}. Similarly, the phenologies of plants and
pollinators must also overlap \citep{Vazquez2009,
  Vazquez2009evaluating}.

 \citep{valdovinos2013adaptive}

The changes in network patterns with assembly also increased the
robustness of the networks to perturbation, but not to plant species
loss.
