...
\begin{abstract}  
  ...
  network position, causing assembly to be punctuated by
  ...
  they visited. Indeed, the most persistent and generalized
  species were also the most variable in their network positions --- the
  opposite of which would be expected by preferential attachment. High
