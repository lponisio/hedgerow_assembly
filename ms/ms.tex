...
is not impossible. Interestingly, most of the assembling hedgerows did
...
TRANSITION... Surprisingly, the species that were most variable in
...
\textit{Halictus tripartitus},\textit{Lasioglossum (Dialictus)
  incompletum}, and \textit{Toxomerus marginatus} --- were also the
only species that changed what module (i.e., community) they were
...
position. Generalized species may be best able to exploit the limited
...
the most advantageous floral resources, which my depend the other
...
specialization to increase, and see no such trends. The stable level
...
time it takes for a perturbation to spread through a network, as
...
robustness. SOMETHING ABOUT DIVERSITY AND STABILITY
