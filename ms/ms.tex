...
\def\extras{
  ...
  \item Main text word count: 4967
...
\begin{abstract}  
  As the world continues to lose species at an alarming rate,
  anticipating a community's ability to resist collapse will depend on
  the strength of interaction networks. We know little, however, about
  how to re-assemble interacting communities through restoration, or
  the process of ecological network assembly more generally. Using an
  ...
  time, causing the community assembly process to be punctuated by
  major network reorganizations. In contrast, the non-assembling
  networks do not restructure as frequently. The most persistent and
  generalized species are also the most variable in their network
  positions, contrary to what is expected by assembly following
  preferential attachment --- a widly supported assembly
  mechanism. Our results fundamentally alter our understanding of how
  communities assembly and how species interactions change through
  time while helping to inform efforts to re-assembly robust
...
When a species goes extinct, more than a species is lost. That species
interacted with other species in its community, likely in ways that
were important or even crucial to others' survival. When a community
--- a unique combination of interacting species --- loses one species,
the system becomes weaker. Global change has created a severe
biodiversity crisis, and as species are lost, so are their
interactions \citep{dunn2009sixth, barnosky2011has}. A community's
ability to resist collapse will depend on the strength of each
interaction network \citep{Memmott2004, Rezende2007, Bascompte2009,
  Thebault2010}. To safeguard ecological function, it has become
increasingly imperative to aid the recovery of lost interactions and
component biodiversity and by facilitating the assembly of robust
interaction networks via ecological restoration
...
zero. %(estimate of the slope of specialization through time $\pm$ SE, $-0.926$ $\pm$ $0.450$, $p$-value=$0.078$).
...
degree or abundance % (estimate
% of the slope of robustness through time $\pm$ SE, $6*10^{-5} \pm
% 4*10^{-3}$, $p$-value=$0.987$) ($0.001 \pm 0.003$,
% $p$-value=$0.65$)
