...
\begin{abstract}  
  ...
  biology. Using a long-term data set comprising nearly $20,000$
  ...
  were also the most variable in their network positions. High species
  and interaction turnover was ubiquitous across assembling and
  non-assembling communities, though unique interactions turned over
  at higher rates in assembling hedgerows as the networks continually
  reorganized. Nestedness of assembling networks also increased
  through time, but there was no increase in robustness to simulated
  plant extinctions. The sensitivity of networks to cascading
  perturbations, however, increased as the communities assembled, at
  least partially due to accumulating species richness. We elucidate
  some of the mechanisms underlying plant-pollinator network assembly
  and restoration, while providing further evidence that hedgerows are
  a valuable tool for promoting species conservation and ecosystem
  service? provision in agricultural areas.
\end{abstract}
...
cascading perturbations. Perturbations can have negative consequences
for the species in the network such as the decrease in abundance of a
plant or pollinator. For example, a pollinator could decrease in
abundance, and the pollination services it provided to the plants it
visited would be diminished. The effected plants would set less seeds,
and decrease in abundance the subsequent year. The pollinators that
depended on those plant species would suffer, and the cascade would
continue to propagate throughout the network. A perturbation could
have a positive effect, like the increase in abundance of a
species. Similar to the negative perturbation, the impact of the
positive perturbation would cascade through the network. The examples
of negative perturbations (e.g., resource collapse, disease,
parasites), however, outnumber possible positive perturbations. Both
of these metrics of network resilience are static --- they do not
...
extinction when species were removed incrementally by degree (estimate
of the slope of robustness through time $\pm$ SE, $6*10^{-5} \pm
4*10^{-3}$, $p$-value=$0.987$) or abundance ($0.001 \pm 0.003$,
